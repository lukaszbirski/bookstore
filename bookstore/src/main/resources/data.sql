...
insert into books("title", "author", "cover_type_id", "description", "ean", "pages", "price", "publisher", "release_date", "file_name")
values ('Wyrwa', 'Wojciech Chmielarz', 2, 'Kiedy Maciej Tomski dowiaduje się, że jego żona Janina zginęła w wypadku samochodowym, myśli, że wali mu się cały świat. Jak powiedzieć dwóm córeczkom, że właśnie straciły matkę? Jak powiedzieć teściom?', 9788366500167, 384, 27393, 'Wydawnictwo Marginesy', '2020-05-06', 'Wyrwa.png');
insert into books("title", "author", "cover_type_id", "description", "ean", "pages", "price", "publisher", "release_date", "file_name")
